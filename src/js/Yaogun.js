...
export default {
  ...
  data () {
    return {
      shuzu:[
      {info:require('../assets/yaogun_03.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥100'},
      {info:require('../assets/yaogun_05.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥188'},
      {info:require('../assets/yaogun_03.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥230'},
      {info:require('../assets/yaogun_03.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥588'},
      {info:require('../assets/yaogun_03.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥666'},
      {info:require('../assets/yaogun_05.png'),name:'小可音乐剧  我变了  , 我..',name1:'￥857'}
      ],
      shuzu1:[
